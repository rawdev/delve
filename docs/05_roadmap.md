...
> - **Phase 0 콘솔 게이트 3건** — R1(Public read)은 **통과했다**: 기능이 없음을 확인하고
>   멤버 초대 + sample 프로젝트 + 정적 export로 계획을 조정했다. 남은 건 R3(ChatGPT/Gemini
>   테스트 저장)와 R2(동료 계정) — **둘 다 Phase 2의 전제**다 (IQ1·IQ2).
