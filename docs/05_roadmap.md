...
>
> **현재: Phase 2 완료.** 턴 시스템 v2(에너지 스케줄러, DQ1) · 인벤토리+세이브 포맷 v2(BQ3) ·
> 적 AI 종류별 정책 + 3종 실제 배치(2-c: `@critic` 설계 ↔ `@developer` 구현 = **IQ1·IQ2**) ·
> 크리틱 검증 결함 3건 수정(BQ1·BQ2 재료). 회고 `evt_5d87719c`로 마감. 게임 플레이 가능
> (5층, FOV, permadeath, 아이템, 속도 다른 적 3종). 다음은 게이트 없는 **Phase 3(밸런스, DQ2).**
>
